...
class PurchaseReturnFilter(django_filters.FilterSet):
    ...
    purchase_id = django_filters.NumberFilter(field_name="purchase__id")
...
class PurchaseReturnAdminFilter(PurchaseReturnFilter):
    ...
    class Meta(PurchaseReturnFilter.Meta):
        pass
