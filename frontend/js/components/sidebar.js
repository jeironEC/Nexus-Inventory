    ...
    build(activePage) {
        ...
        const structure = [
            ...
            },
            {
                label: 'Reportes',
                items: [
                    { path: 'html/sales_report.html', page: 'reports/sales.html', icon: 'receipt_long', text: 'Reporte de Ventas' },
                    { path: 'html/purchases_report.html', page: 'reports/purchases.html', icon: 'shopping_bag', text: 'Reporte de Compras' },
                    { path: 'html/inventory_report.html', page: 'reports/inventory.html', icon: 'inventory_2', text: 'Reporte de Inventario' },
                    { path: 'html/products_report.html', page: 'reports/products.html', icon: 'list_alt', text: 'Reporte de Productos' },
                    { path: 'html/customers_report.html', page: 'reports/customers.html', icon: 'group', text: 'Reporte de Clientes' },
                    { path: 'html/returns_report.html', page: 'reports/returns.html', icon: 'assignment_return', text: 'Reporte de Devoluciones' },
                    { path: 'html/invoices_report.html',  page: 'reports/invoices.html',  icon: 'receipt',  text: 'Reporte de Facturación' }
                ]
            },
            {
                label: 'Sistema',
